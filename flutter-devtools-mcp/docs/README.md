...
| 文档 | 受众 | 说明 |
|------|------|------|
| [performance-metrics-guide.md](./performance-metrics-guide.md) | **开发者（优先读）** | 指标含义、报告怎么读、GC/重建/图片解码、profile vs debug |
...
| [../README.zh-CN.md](../README.zh-CN.md) | 全员 | 安装、快速开始、工具表、回归命令 |
